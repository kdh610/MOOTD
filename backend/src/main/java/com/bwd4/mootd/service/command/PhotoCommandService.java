package com.bwd4.mootd.service.command;
...
import com.bwd4.mootd.service.AIService;
...
public class PhotoCommandService{
    ...
    @Autowired
    public PhotoCommandService(PhotoRepository photoRepository, S3Service s3Service, Scheduler asyncScheduler, PhotoUsageHistoryRepository photoUsageHistoryRepository, AIService aiService, ReactiveMongoTemplate reactiveMongoTemplate, PhotoElasticSearchRepository photoElasticSearchRepository) {
